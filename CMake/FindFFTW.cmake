...
##
## To use the MKL implementation, set `ITK_USE_MKL` to ON after setting
## `ITK_USE_FFTWD` or `ITK_USE_FFTWF` to ON, and set `MKL_ROOT` to the
## installation directory of the MKL library on your system and point
## to the `mkl` subdirectory:
...
option(ITK_USE_MKL "Use system MKL" OFF)
if(ITK_USE_MKL)
...
if(ITK_USE_FFTWD OR ITK_USE_FFTWF)
  ...
  if(ITK_USE_MKL)
    if(WIN32)
      set(MKL_ROOT "C:/Program Files (x86)/IntelSWTools/compilers_and_libraries/windows/mkl" CACHE PATH "Intel path containing MKL subdirectory.")
    elseif(APPLE)
      set(MKL_ROOT /opt/intel/compilers_and_libraries/mac/mkl CACHE PATH "Intel path containing MKL subdirectory.")
    elseif(${CMAKE_SYSTEM_NAME} MATCHES "Linux")
      set(MKL_ROOT /opt/intel/compilers_and_libraries/linux/mkl CACHE PATH "Intel path containing MKL subdirectory.")
    else()
      message(FATAL_ERROR "System not supported for MKL")
    endif()
    set(FFTW_INC_SEARCHPATH ${MKL_ROOT}/include/fftw)
  else()
  ...
  if(ITK_USE_MKL)
    ...
    if(CMAKE_SIZEOF_VOID_P EQUAL "8")
      if(APPLE)
        set(FFTW_LIB_SEARCHPATH ${MKL_ROOT}/lib)
      else()
        set(FFTW_LIB_SEARCHPATH ${MKL_ROOT}/lib/intel64)
      endif()
      ...
      set(FFTW_LIB_SEARCHPATH ${MKL_ROOT}/lib/ia32)
      if(WIN)
