...
#              [FORWARD_EXPORT_MACRO_NAME <forward_export_macro_name>]
#              [EXPORT_FILE_NAME <export_file_name>]
#              [DEPRECATED_MACRO_NAME <deprecated_macro_name>]
#              [NO_EXPORT_MACRO_NAME <no_export_macro_name>]
#              [FORWARD_NO_EXPORT_MACRO_NAME <forward_no_export_macro_name>]
...
macro(_DO_SET_MACRO_VALUES TARGET_LIBRARY)
  ...
  set(DEFINE_FORWARD_EXPORT)
  set(DEFINE_FORWARD_IMPORT)
  set(DEFINE_FORWARD_NO_EXPORT)
  if (COMPILER_HAS_DEPRECATED_ATTR)
  ...
  if(NOT ${type} STREQUAL "STATIC_LIBRARY")
    ...
    elseif(COMPILER_HAS_HIDDEN_VISIBILITY AND USE_COMPILER_HIDDEN_VISIBILITY)
      ...
      if(APPLE)
        set(DEFINE_FORWARD_EXPORT "${DEFINE_EXPORT}")
        set(DEFINE_FORWARD_IMPORT "${DEFINE_IMPORT}")
        set(DEFINE_FORWARD_NO_EXPORT "${DEFINE_NO_EXPORT}")
      endif()
    endif()
  endif()
endmacro()
...
macro(_DO_GENERATE_EXPORT_HEADER TARGET_LIBRARY)
  ...
  set(oneValueArgs PREFIX_NAME BASE_NAME EXPORT_MACRO_NAME
    TEMPLATE_EXPORT_MACRO_NAME FORWARD_EXPORT_MACRO_NAME EXPORT_FILE_NAME
    DEPRECATED_MACRO_NAME NO_EXPORT_MACRO_NAME FORWARD_NO_EXPORT_MACRO_NAME STATIC_DEFINE
  ...
  set(FORWARD_EXPORT_MACRO_NAME "${_GEH_PREFIX_NAME}${BASE_NAME_UPPER}_FORWARD_EXPORT")
  set(NO_EXPORT_MACRO_NAME "${_GEH_PREFIX_NAME}${BASE_NAME_UPPER}_NO_EXPORT")
  set(FORWARD_NO_EXPORT_MACRO_NAME "${_GEH_PREFIX_NAME}${BASE_NAME_UPPER}_FORWARD_NO_EXPORT")
  ...
  if(_GEH_FORWARD_EXPORT_MACRO_NAME)
    set(FORWARD_EXPORT_MACRO_NAME ${_GEH_PREFIX_NAME}${_GEH_FORWARD_EXPORT_MACRO_NAME})
  endif()
  ...
  if(_GEH_FORWARD_NO_EXPORT_MACRO_NAME)
    set(FORWARD_NO_EXPORT_MACRO_NAME ${_GEH_PREFIX_NAME}${_GEH_FORWARD_NO_EXPORT_MACRO_NAME})
  endif()
  if(NOT CMAKE_VERSION VERSION_LESS 2.8.12)
