...
class ITK_TEMPLATE_FORWARD_EXPORT TreeNodeChangeEvent;

template< typename TTreeType >
class ITK_TEMPLATE_FORWARD_EXPORT TreeAddEvent;

template< typename TTreeType >
class ITK_TEMPLATE_FORWARD_EXPORT TreePruneEvent;

template< typename TTreeType >
class ITK_TEMPLATE_FORWARD_EXPORT TreeRemoveEvent;
