...
class ITK_TEMPLATE_EXPORT NthElementPixelAccessor
{
public:
...
class ITK_TEMPLATE_EXPORT NthElementPixelAccessor< TOutputPixelType, itk::VariableLengthVector<TPixelType> >
